<template>
  <div class="detail-box">
    ...
    <ShareModal ref="shareModalRef" :link="shareLink" :title="title"/>
  </div>
</template>
...
const canEdit = computed(() => {
  ...
  return loginUser.id === user.id || loginUser.userRole === 'admin' || loginUser.userRole === 'root'
})
...
// 编辑
const doEdit = () => {
  router.push('/picture/edit_picture?id=' + picture.value.id)
}
// 删除
